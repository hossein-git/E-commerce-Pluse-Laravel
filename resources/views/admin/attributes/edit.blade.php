   ...
   <form id="attr_form" method="post" action="{{ route('attribute.update', $id) }}">
      ...
      <div class="row">
         <div class="col-sm-3">
            ...
            <input class="btn btn-success"  id="submit" type="submit" value="SAVE" ><div class="space-2"></div>
            <button class="btn btn-danger" data-id="" id="destroy_attr" title="delete attribute and its values" disabled="">DELETE</button>
            <a href="{{ route('attribute.createNew',$id) }}" class="btn btn-warning bolder"  id="destroy_attr" title="add new attribute">New Attribute</a>
         </div>
   ...
   <script type="text/javascript">
           ...
           $("#destroy_attr").click(function (e) {
               ...
               $.ajax({
                   ...
                   success: function ($results) {
                       alert('attribute has been successfully deleted');
       ...
       function deleteValue(elem) {
           ...
           $.ajax({
               ...
               success: function ($results) {
                   $(".preview").hide();
                   alert('attribute Value has been successfully deleted');
